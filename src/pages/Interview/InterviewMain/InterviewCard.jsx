...
const InterviewCard = ({ dataInterview }) => {
    ...
    const handleButton = (interviewID) => {
        ...
        <div className='grid grid-cols-3 gap-10 ' style={{ paddingTop: 25 }}>
            ...
            {paginatedData && Array.isArray(paginatedData) && paginatedData.map((item) => (
                ...
                <div className='bg-white h-[280px] rounded-xl '>
                    <div style={{ fontSize: 22, fontWeight: 500, paddingTop: '8%', paddingLeft: '10%' }}>{item.titleJob}</div>
                    <div style={{ fontSize: 15, fontWeight: 200, paddingTop: '1%', paddingLeft: '10%' }}>{item.descriptionJob}</div>
                    <label
                        style={{
                            backgroundColor:
                    ...
                    <div>
                        ...
                        >
                            {item.listAvatar && item.listAvatar.map((avatar) => (
                    ...
                    <div style={{ paddingTop: '3%', paddingLeft: '34%' }}>
                        <Button
                            onClick={() => handleButton(item.interviewID)}
