...
function CVBuilder() {
  ...
  return (
    ...
    <div className="cv-builder" ref = {componentsPDF}  style = {{backgroundImage: "url('https://cv.fullstack.edu.vn/backgrounds/graph-dot-top-458966.svg')", backgroundPosition: "center", backgroundSize: "contain"}}>
      <Container>
        <Row>
          <Col xs={8}>
            <Row>
